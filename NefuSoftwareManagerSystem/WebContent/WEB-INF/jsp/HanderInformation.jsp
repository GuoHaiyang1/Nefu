...
<c:forEach items="${handerInformation}" var="i">
<tr>
...
<td>
<c:if test="${i.invigilate.state==0 }">
<span>未分配</span>
</c:if>
  ...
  <div class="container-fluid">
        <div class="row">
            <div class="col-sm-2">
                ...
                <a href="/NefuSoftwareManagerSystem/HanderInformation" class="list-group-item active">
